...
# =============================================================================
# Bonsai Backend Docker Image Publisher
# =============================================================================
#
# This script automates the process of building, testing, and publishing
# the backend Docker image to DockerHub. It performs the following steps:
#
...
docker run -d -p 8000:8000 --name test-container ${DOCKER_USERNAME}/${IMAGE_NAME}:${VERSION}
